...
## List Of Completed Chapters (things in brackets are good things to remember from each chapter)
  ...
  Chapter 3: Organising objects with classes (Explains instance variables eg ***@name***, class variables eg ***@@name***. Explains attr_* methods eg ***attr_reader :name***,  ***attr_writer :name***,  ***attr_accessor :name*** . In Ruby, an instance method provides functionality to an Object. A class method provides functionality to a class itself.)
